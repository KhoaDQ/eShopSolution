...
namespace eShopSolution.BackendAPI.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        [HttpGet("{id}")]
        public async Task<IActionResult> GetById(Guid id) // FromQuery mean that all parameters of request is taked from Query, it also be used in Get method // FromBody with Post method
        {
